...
export default function SpecialsPage() {
  ...
  const specials = [
    ...
    { id: 305, name: 'Whipped Cream', price: 90, category: 'extra', image: '/whippedcream.jpg' }
  ];
              ...
              return (
                <div key={product.id} className="bg-white shadow-md p-4 flex flex-col">
                  ...
                  <div className="mt-4">
                    {quantity === 0 ? (
                      <button 
                        onClick={() => product.category === 'special' ? handleAddToCart(product) : addToCart(product)}
