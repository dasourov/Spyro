    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#136356" }}>
      ...
      <main className="flex-grow px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold text-white mb-2">Lemonades Menu</h1>
          <p className="text-gray-200">Choose from our selection of lemonades</p>
          <p className="text-gray-200 mb-8">⭐ All products price include the VAT</p>
          
          {/* Grid layout */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            {lemonades.map(product => {
                  ...
                  <div className="w-1/4">
                    <img 
                      ...
                      onError={(e) => {
                        ...
                        e.target.src = "https://via.placeholder.com/150?text=Lemonade";
                      }}
                    />
                  </div>
